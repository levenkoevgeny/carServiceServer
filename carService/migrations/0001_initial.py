    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('district', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carService.district', verbose_name='Район')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='carService.address', verbose_name='Адрес')),
            ],
            options={
                'verbose_name': 'Заказ',
